...
void main() {
  ...
  test('isRoomAvailableForDates returns false when dates overlap confirmed booking', () async {
    ...
    await db.collection('reservations').doc(existing.id).set(existing.toMap());
  ...
  test('isRoomAvailableForDates returns true when dates do not overlap', () async {
    final existing = Reservation(
      id: 'existing',
      userId: 'userB',
      hotelId: 'hotel1',
